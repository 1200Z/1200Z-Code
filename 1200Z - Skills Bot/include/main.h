...
#define gyro_port 3
#define intake_pot 2 //Ranges from 12(fully in) to 1580(fully out)

//Define digital sensors by their ports
#define intake_switch 5
#define base_bump 6
#define brake 7
...
//Define constants for baseDirection variable in baseMove
#define Up 201
#define Down 202
...
#define WristHold 0
#define LiftHold 0
#define RollerHold -10

//Define constants for autonomous functions
#define MIN_DRIVE_POWER 20
#define TICKS_PER_ROT 360
#define TICKS_PER_INCH 27.1

//Define global variables
int baseSetHeight;//desired potentiometer value for base intake, used in baseControl task
int baseDirection;//Set equal to Up or Down, used in baseMove task
bool holdingBase;//Set true if we are holding a mobile goal, used in driverBaseControl
int autonSelect;//Variable keep track of autonomous selection
